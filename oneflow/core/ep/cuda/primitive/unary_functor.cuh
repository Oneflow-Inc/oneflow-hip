...
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipComplex, Src> {
  ...
  OF_DEVICE_FUNC hipComplex operator()(Src src) const {
    return make_hipComplex(static_cast<float>(src), 0.0);
  }
};

template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipComplex, hipComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}

  OF_DEVICE_FUNC hipComplex operator()(hipComplex src) const { return src; }
};

template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipComplex, hipDoubleComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}

  OF_DEVICE_FUNC hipComplex operator()(hipDoubleComplex src) const {
    return hipComplexDoubleToFloat(src);
  }
};

template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipComplex, half> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}

  OF_DEVICE_FUNC hipComplex operator()(half src) const {
    return make_hipComplex((__half2float(src)), 0.0);
  }
};

template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kIdentity, hipComplex, hipComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kConj, hipComplex, hipComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}
  OF_DEVICE_FUNC hipComplex operator()(hipComplex src) const { return hipComplex{src.x, -src.y}; }
};

// reference : thrust: `thrust/detail/complex/csqrtf.h:csqrtf`
template<>
struct UnaryFunctor<kCUDA, UnaryOp::kSqrt, hipComplex, hipComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}

  OF_DEVICE_FUNC hipComplex operator()(hipComplex src) const {
...
template<typename Src>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipDoubleComplex, Src> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}

  OF_DEVICE_FUNC hipDoubleComplex operator()(Src src) const {
    return make_hipDoubleComplex(static_cast<double>(src), 0.0);
  }
};

template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipDoubleComplex, hipDoubleComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kCast, hipDoubleComplex, hipComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kConj, hipDoubleComplex, hipDoubleComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}
  OF_DEVICE_FUNC hipDoubleComplex operator()(hipDoubleComplex src) const {
    return hipDoubleComplex{src.x, -src.y};
  }
};

template<>
struct UnaryFunctor<DeviceType::kCUDA, UnaryOp::kSqrt, hipDoubleComplex, hipDoubleComplex> {
  OF_DEVICE_FUNC UnaryFunctor(Scalar attr0, Scalar attr1) {}
...
SPECIALIZATION_COMPLEX_ARITHMETIC_UNARY_FUNCTOR(UnaryOp::kNegative, hipComplex, float);
SPECIALIZATION_COMPLEX_ARITHMETIC_UNARY_FUNCTOR(UnaryOp::kNegative, hipDoubleComplex, double);
