...
INSTANTIATE_REAL_FUNCTOR(DeviceType::kCUDA, hipComplex, float)
INSTANTIATE_REAL_FUNCTOR(DeviceType::kCUDA, hipDoubleComplex, double)
...
INSTANTIATE_REAL_GRAD_FUNCTOR(DeviceType::kCUDA, float, hipComplex)
INSTANTIATE_REAL_GRAD_FUNCTOR(DeviceType::kCUDA, double, hipDoubleComplex)
...
INSTANTIATE_IMAG_FUNCTOR(DeviceType::kCUDA, hipComplex, float)
INSTANTIATE_IMAG_FUNCTOR(DeviceType::kCUDA, hipDoubleComplex, double)
...
INSTANTIATE_IMAG_GRAD_FUNCTOR(DeviceType::kCUDA, float, hipComplex)
INSTANTIATE_IMAG_GRAD_FUNCTOR(DeviceType::kCUDA, double, hipDoubleComplex)
...
INSTANTIATE_CONJ_PHYSICAL_FUNCTOR(DeviceType::kCUDA, hipComplex)
INSTANTIATE_CONJ_PHYSICAL_FUNCTOR(DeviceType::kCUDA, hipDoubleComplex)
