...
#endif
#ifdef WITH_ROCM
REGISTER_FFTC2C_KERNELS(DeviceType::kCUDA, hipComplex, float);
REGISTER_FFTC2C_KERNELS(DeviceType::kCUDA, hipDoubleComplex, double);
#endif
...
#endif
#ifdef WITH_ROCM
REGISTER_FFTR2C_KERNELS(DeviceType::kCUDA, float, hipComplex);
REGISTER_FFTR2C_KERNELS(DeviceType::kCUDA, double, hipDoubleComplex);
#endif
...
#endif
#ifdef WITH_ROCM
REGISTER_FFTC2R_KERNELS(DeviceType::kCUDA, hipComplex, float);
REGISTER_FFTC2R_KERNELS(DeviceType::kCUDA, hipDoubleComplex, double);
#endif
}  // namespace oneflow